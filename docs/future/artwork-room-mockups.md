...
> **⏸ Parked.** Backend-owned exploration; the landing-side expectations in this
> doc (`mockups[]` in API types, room-switcher UI) are **unimplemented**. Revival
> requires an owner decision — see `docs/enredarte-overview.md` §7.
