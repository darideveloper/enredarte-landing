...
#### Scenario: Hero LCP forwards priority
- **WHEN** `Hero.astro` renders `ImageBanner` for the LCP artwork
- **THEN** the inner image carries `loading="eager" fetchpriority="high"` instead of the lazy default
