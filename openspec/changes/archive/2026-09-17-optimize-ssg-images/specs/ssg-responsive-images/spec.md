...
- **WHEN** the build processes `logo.png` / `og-image.jpg` / hero fallback from `src/assets/`
- **THEN** WebP/AVIF variants with intrinsic dimensions are emitted; favicons stay in `public/` verbatim
