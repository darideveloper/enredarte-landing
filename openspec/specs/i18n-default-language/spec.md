# i18n-default-language Specification

## Purpose
Defines the routing, language-detection, translation-fallback, redirect, and SEO behaviors that make Spanish the default (unprefixed) language and English the prefixed one.
