...
## Purpose
Strict opt-in analytics consent: a first-visit banner, Consent Mode v2 deny-by-default, gated GA4 loading and events, persisted choice, and footer re-consent — no tracking fires before the visitor grants it.
