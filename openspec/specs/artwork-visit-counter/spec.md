...
## Purpose
Records artwork views from the browser against the public visit endpoint (`POST /api/artworks/artworks/:slug/visit/`) — one fire-and-forget call per artwork detail-page mount, with no display of the count.
