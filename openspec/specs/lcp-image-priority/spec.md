## Purpose
Exactly one above-the-fold image per page loads with top priority and a matching responsive preload, so LCP is fast without competing requests or double-downloads.
